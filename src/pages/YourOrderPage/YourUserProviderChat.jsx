...
import {
  ...
  markMessageAsSeen,
} from "./api/your-notification-api";
import moment from "moment";
const singleTickIcon = `${IMAGE_BASE_URL}/single-tck.png`;
const doubleTickIcon = `${IMAGE_BASE_URL}/double-tck.png`;
import "./YourUserProviderChat.css";
